...
section: System
chapter: Hardware
title: NUgus Specification
description: Specification and overview for the NUgus robot used by NUbots.
...
The NUgus robot uses two [FLIR Blackfly S](https://www.teledynevisionsolutions.com/en-au/products/blackfly-s-usb3) USB3 cameras with a C-Mount lens positioned in their head, producing images at up to 170FPS. Two custom-built S-Mount to C-Mount lens adaptors are used to attach two [Lensation 180° fisheye S-Mount lenses](https://www.lensation.de/product/BF10M19828S118C/). Two [20" USB3 micro USB to up angle USB A cables](https://www.angledcables.com/parts/rr-aums-xxgr.html#RR-AUMS-20GR) are used to connect the cameras to the robot's computer.

## Computing

The NUgus robot uses the [Intel NUC12WSHi7](https://www.intel.com/content/www/us/en/products/sku/121640/intel-nuc-12-pro-kit-nuc12wshi7/specifications.html). It has 32GB of RAM, a 1TB SSD, and a NUsense subcontroller.
...
The NUgus robot has a [Cosel AC/DC Power Supply](https://www.powerbox.com.au/products/cosel-pbb20c-series). It uses a [4200mAh 4S LiPo Battery](https://www.campbelltownhobbies.com.au/nxe-14.8v-4200mah-40c-soft-case-with-deans-plug-42?srsltid=AfmBOopsSRXZSrXw4AsKhPQgUhmWyOqvFeGJkwsGQ3VU2ZQyUqlf4PYQ) when not plugged into power. It uses a custom power assembly and a custom 16A cylindrical fuse holder. The NUC power board which distributes power to the cooling fan and the NUC is also custom.
