...
- The custom mounts that retain MX style idle wheels due to x-series idle horn design are detrimental to the robot and should be upgraded in future.
...
The NUgus robot uses the [Intel NUC12WSHi7](https://www.intel.com/content/www/us/en/products/sku/121640/intel-nuc-12-pro-kit-nuc12wshi7/specifications.html). It has 32GB of RAM, a 1TB SSD, and NUsense.
