...
The playing field displays all the robots that are currently connected to NUsight. The yellow rectangle indicates our own goal. The blue one is the opponent's goal.

|         Item         |  &nbsp Image &nbsp &nbsp &nbsp &nbsp &nbsp  | Description                                                                                                                 |
| :------------------: | :-----------------------------------------: | --------------------------------------------------------------------------------------------------------------------------- |
| Robot Representation |    ![](./images/dashboard-robot-rep.png)    | Displays the robot's number assigned by NUsight. The wedge on the robot indicates the direction of the robot's orientation. |
|      Black Arcs      | ![](./images/dashboard-robot-walk-path.png) | Indicates the robot's walk path.                                                                                            |
|         Ball         | ![](./images/dashboard-ball-direction.png)  | Indicates where the robot things the ball is located.                                                                       |
|     Green Arrow      |    ![](./images/dashboard-ball-kick.png)    | Indicates how the robot will kick the ball. Usually it should point towards the opponent's goal.                            |
...
![Visual Mesh](./images/visual-mesh-main.png)
