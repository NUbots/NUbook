...
The NUsight visualisation system is a web-based visualiser created in-house for the NUbots team. It provides real-time display of information of messages passed inside the NUClear robotics framework. The data that can be visualised in NUsight may come from real hardware or simulated hardware. NUsight contains multiple tabs with different debugging capabilities.
...
The 'Flip Orientation' button in the top left hand corder flips the playing field to display the mirror image of the previous view of the playing field.
...
| Feature          | &nbsp Image &nbsp &nbsp &nbsp &nbsp &nbsp                                                                           | Description                                                                                                                                       |
| ---------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
...
The localisation view shows a 3D model of any connected robots with their position and orientation on the field.
...
| Right Panel           | Select which variable from which robot is to be plotted on the chart.                                                             |
