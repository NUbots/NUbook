...
1.	Set up configuration
    ...
    -	The NSGA2 configuration file is located in the NUbot repository at module/support/optimisation/NSGA2Optimiser/data/config/NSGA2Optimiser.yaml, is an important file as it contains the configuration settings for the optimiser:- 
        That is the task to be optimised and the task optimisation parameters. This file is optimiastion specific. A new one will have to be written for each collections of optimisation tasks. Please see below for the example used 
...
### Optimisation of Walk Engine example
