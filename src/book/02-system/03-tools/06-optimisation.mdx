...
chapter: Tools
title: NUOptimiser
description: NSGA2 documentation.
slug: /system/tools/optimiser
authors:
...
This module is used for optimisation of a chosen set paramters on the NUgus robots, for the task you wish to optimise. These parameters are evaluated using the Webot simulation environment.
This document first provides some background information on the NUBots optimisation system, then describes how to setup and work with the NUoptimiser, with an example of the optimiser use on the NUgus
quintic walk engine.
...
This module was orignally used for optimisation of a chosen set of walk engine paramters for the NUgus robots. These parameters are evluated using the Webot simulation environment.
This document first provides some background information on the NUBots optimisation system, then describes how to setup and work with the NUoptimiser, with an example of the optimiser use on the NUgus
quintic walk engine.
