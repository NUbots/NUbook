...
1.	Set up configuration
    ...
    -	Locate the file module/support/optimisation/NSGA2Optimiser/data/config/NSGA2Optimiser.yaml. This is an important file as it contains the configuration for the optimiser: the task to be optimised
        and the task optimisation parameters.
