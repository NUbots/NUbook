...
2. Install the latest version of Node.js [here](https://nodesource.com/products/distributions). Select your operating system and run the commands provided in a terminal.
