...
2. Install Node.js version 14 by following the instructions [here](https://github.com/nodesource/distributions/blob/master/README.md#installation-instructions) and running the commands under "Node.js v14.x".

3. Install the latest version of Yarn
