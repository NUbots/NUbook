...
![The classifications from the Visual Mesh neural network.](./images/vision-green-horizon-balls-detections.png 'The classifications from the Visual Mesh neural network.')
...
![The full output of the vision system showing the green horizon, ball and goal detections.](./images/vision-balls-goals.png 'The full output of the vision system showing the green horizon, ball and goal detections.')
