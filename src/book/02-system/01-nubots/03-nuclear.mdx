...
| `roles`     | contains all the NUClear roles files.                                                                                                                                                               |
| `tools`     | contains any command line extensions for the `b` script, such as `build` and `configure`.                                                                                                           |

## Roles

Roles are executables containing all the modules to be used. They are called `<executablename>.role`, where `<executablename>` is the name of the final binary that will be created.
...
Within `nuclear/b` there is a python tool called `b`. This python tool is used to handle common functionality in the system.

The `./b` script will look for a `tools` directory above the location where the actual `b.py` is located. If it finds one, it will load all `.py` files in that directory and attempt to execute a register and run function on them. This allows the tools to register new functionality to the b script that can be accessed from the command line.

Tools that exist in the NUbots codebase are:

| Tool                                                                           | Description                                                                                              |
| ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- |
| [`build`](https://github.com/NUbots/NUbots/blob/master/tools/build.py)         | Builds the codebase.                                                                                     |
| [`configure`](https://github.com/NUbots/NUbots/blob/master/tools/configure.py) | Configures targets. Use the argument `-i` to perform an interactive configuration.                       |
| [`edit`](https://github.com/NUbots/NUbots/blob/master/tools/edit.py)           | What does this do??                                                                                      |
| [`footdown`](https://github.com/NUbots/NUbots/blob/master/tools/footdown.py)   | Tool for training the footdown network.                                                                  |
| [`format`](https://github.com/NUbots/NUbots/blob/master/tools/format.py)       | Formats all files using clang-format.                                                                    |
| [`install`](https://github.com/NUbots/NUbots/blob/master/tools/install.py)     | Installs NUClear roles systems onto remote systems using rsync. This is used to install onto the robots. |
| [`nbs`](https://github.com/NUbots/NUbots/blob/master/tools/nbs.py)             | Decodes `.nbs` files.                                                                                    |
| [`run`](https://github.com/NUbots/NUbots/blob/master/tools/run.py)             | Runs a binary file within the Docker container.                                                          |
| [`shell`](https://github.com/NUbots/NUbots/blob/master/tools/shell.py)         | Opens an interactive shell in the Docker container.                                                      |
| [`target`](https://github.com/NUbots/NUbots/blob/master/tools/target.py)       | Used to select the default platform to use for docker commands.                                          |
