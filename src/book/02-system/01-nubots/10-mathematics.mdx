...
NUbots use a **right-handed coordinate system** where the x-axis is **forward**, the y-axis is to the **left** and the z-axis is **up**. In field coordinates, the x-axis is toward the opponent's goal.
