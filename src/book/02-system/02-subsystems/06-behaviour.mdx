...
| L2                        | Left  kick.                                |
| DPAD Up                   | Step Clap 1.                               |
| DPAD Down                 | Step Clap 2.                               |
| DPAD Left                 | Overhead Thrust Right.                     |
| DPAD Right                | Overhead Thrust Left.                      |
| Triangle                  | Star 1.                                    |
| Circle                    | Star 2.                                    |
| Cross                     | Crouch 1.                                  |
| Square                    | Crouch 2.                                  |
...
The robot will initially not perform any action. If you want the robot to stand, pick up the robot and press the start button. It will then move to its standing position.
