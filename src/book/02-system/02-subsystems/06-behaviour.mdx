...
The [**fake_keyboardwalk** role](https://github.com/NUbots/NUbots/blob/main/roles/fake_keyboardwalk.role) uses HardwareSimulator, and is useful for when you don't want to run keyboard walk on the robot.
