...
<details>
<summary>Play-States and Considerations (RoboCup 2022)</summary>

Based on the rules as specified in the [RoboCup Humanoid Rules](https://github.com/RoboCup-Humanoid-TC/Rules) there are some states in the game such as when a penalty occurs in favor of the opposing team which recieves either a direct or indirect free kick, where the robots need to then act in a particular way such as standing still, or moving out of the way for the kick for the duration of the kick.

[In the revision of the rules as per March 24th 2022:](http://humanoid.robocup.org/wp-content/uploads/RC-HL-2022-Rules.pdf)

### _All free kicks are taken from the place where the offence occurred, except:_

- _Indirect free kicks to the attacking team for an offence inside the opponents' penalty area are
  taken from the nearest point on the penalty area line which runs parallel to the goal line._

- _In the physical competition, free kicks to the defending team in their goal area may be taken
  from anywhere in that area_

### _Until the ball is in play all opponents must remain:_

- _0.75m for KidSize and 1.5m for AdultSize from the ball until it is in play, unless they are on their own goal line between the goalposts_

- _Outside the penalty area for free kicks inside the opponents' penalty area_
