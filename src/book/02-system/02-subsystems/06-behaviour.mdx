...
The module connects to the PS3 controller using USB and reacts based on joystick or button input.
...
| R2                        | Right kick.                                |
| L2                        | Left kick.                                 |
| DPAD Up                   | Perform Step Clap 1 move.                  |
| DPAD Down                 | Perform Step Clap 2 move.                  |
| DPAD Left                 | Perform Overhead Thrust Right move.        |
| DPAD Right                | Perform Overhead Thrust Left move.         |
| Triangle                  | Perform Star 1 move.                       |
| Circle                    | Perform Star 2 move.                       |
| Cross                     | Perform Crouch 1 move.                     |
| Square                    | Perform Crouch 2 move.                     |
