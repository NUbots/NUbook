...
This page details motion modules within the NUbots main codebase, such as the walk engine and the Script Engine. Script Runner and Script Tuner are on the [Behaviour](/system/subsystems/behaviour#script-runner) page.
...
The walk engine will trigger when a [**walkcommand**](https://github.com/NUbots/NUbots/blob/master/shared/message/motion/WalkCommand.proto) is [**emitted**](/system/foundations/nuclear#emit-statements). The walk command gives a vector [x, y, z] which represents:
