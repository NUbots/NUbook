...
The motion subsystem contains modules that send servo targets to the motors. These include walking, kicking, moving the head, and running scripts.
...
| ID       | One of a list of servo IDs found in [ServoID.h](https://github.com/NUbots/NUbots/blob/467f458c687419056e2487fe468c7f22d19a6965/shared/utility/input/ServoID.h#L30). |
