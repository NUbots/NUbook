...
| `roll_offset`       | float (radians)      | Roll of the camera in radians to account for physical differences from manufactoring and assembly to align with the camera's virtual focal point.     |
| `pitch_offset`      | float (radians)      | Pitch of the camera in radians to account for physical differences from manufactoring and assembly to align with the camera's virtual focal point.    |
