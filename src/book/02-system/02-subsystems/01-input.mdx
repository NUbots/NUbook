...
The cameras used on the NUgus robot are [Flir Blackfly S USB3's](https://www.flir.com/support/products/blackfly-s-usb3/?vertical=machine+vision&segment=iis#Overview).

The [Spinnaker SDK](https://www.flir.com/support-center/iis/machine-vision/downloads/spinnaker-sdk-and-firmware-download/) is FLIR's Genicam API library which includes a GUI program called SpinView, used to operate the cameras from a PC, as well as extensive documentation.
