...
The image description should present the content and function of the image. Find guides on writing good alternative text on [WebAIM](https://webaim.org/techniques/alttext/) and [Moz](https://moz.com/learn/seo/alt-text).
