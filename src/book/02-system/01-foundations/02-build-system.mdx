...
The `./b extract-documentation` command generates a JSON file documenting each module. It lists each reactor, with their on statements and emit statements. The on and emit statements have their location in the file and their DSL words also.
