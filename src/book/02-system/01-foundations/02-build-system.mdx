...
This script copies the modified scripts back into your local codebase, ready for committing to our GitHub.

- Recordings get copied to `recordings/`

- Configs get scanned for whether they are global or specific to a robot, then sent to the correct folder

- Scripts also get scanned for locality then sent to the correct place
