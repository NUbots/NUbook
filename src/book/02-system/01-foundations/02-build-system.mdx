...
| BINARY           | A binary that is a part of the library                                                        |
| BINARY_ARGUMENTS | The arguments to pass to the binary                                                           |
| VERSION_FILE     | A file that contains information on the version of the library                                |
| VERSION_REGEX    | The regex used on the version file to extract the version                                     |
