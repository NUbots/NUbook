...
To have not need to run this each time you can add it to your `.bashrc`, but you need to provide the full path to the NUbots folder. e.g. `eval "$(register-python-argcomplete $HOME/code/NUbots/b)"`.

<details>
<summary>zsh</summary>

You need to use `bashcompinit` to use the bash completions.
