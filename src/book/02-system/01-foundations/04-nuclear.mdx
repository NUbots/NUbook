...
This emits a [`Sensors`](https://github.com/NUbots/NUbots/blob/e7db7154a689ab076041375894b3baf1d53a2587/shared/message/input/Sensors.proto) message. This can then be received by reactors waiting for a `Sensors` message to trigger the reaction.
