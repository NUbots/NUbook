...
Robot space is defined with the **x-axis** pointing **forward** out of the torso, the **y-axis** is to the **left** and the **z-axis** is **up** the neck. The origin of this space is the base of the torso between the legs projected to the ground.
