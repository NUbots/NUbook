...
We currently use the [Eigen](https://libeigen.gitlab.io/eigen/docs-nightly/index.html) C++ template library for linear algebra in the NUbots codebase. Be aware that Eigen has some common pitfalls that are listed on the [Eigen pitfalls page](https://libeigen.gitlab.io/eigen/docs-nightly/TopicPitfalls.html).
...
- [Essence of Linear Algebra by 3blue1brown](https://www.3blue1brown.com/lessons/eola-preview/)

- [Wolfram MathWorld](http://mathworld.wolfram.com/)

- [Eigen Documentation](https://libeigen.gitlab.io/eigen/docs-nightly/index.html)

- [Eigen Pitfalls](https://libeigen.gitlab.io/eigen/docs-nightly/TopicPitfalls.html)
