...
We currently use the [Eigen](https://eigen.tuxfamily.org/) C++ template library for linear algebra in the NUbots codebase. Be aware that Eigen has some unique pitfalls and these are listed on the [Eigen pitfalls page](https://eigen.tuxfamily.org/dox/TopicPitfalls.html).
...
See the [glossary](../../03-guides/04-general/03-glossary.mdx).
