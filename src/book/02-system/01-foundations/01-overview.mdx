...
| `test_balllocalisation` | Test and tune how well the robot detects balls on a field.                                                                                                                                             |
...
| `test_visualmesh`       | Test the vision system on a real robot.                                                                                                                                                                |
| `webots_keyboardwalk`   | Test motions in Webots with manual control.                                                                                                                                                            |
