...
You can find free downloads for [Ubuntu](https://ubuntu.com/), a user-friendly Linux distribution, at their website. Instructions for getting started with NUbots code can also be found at [the NUbots repository](https://github.com/NUbots/NUbots).
