...
In the terminal, change directory to where you have the repo cloned.

### Select Branch

If you are working within an existing project, then you need to find out which branch the work is on. To list the branches, use `git branch`. When you have found the branch you want to push to, swap to it:
