...
![A soccer field with a marker in the middle of the left half of the field labelled 'robot'. An arrow pointing up from this marker is labelled 'y', and an arrow pointing towards the other side of the field is labelled 'x'.](./images/field-axis.svg 'Coordinates relative to a robot on the field')
