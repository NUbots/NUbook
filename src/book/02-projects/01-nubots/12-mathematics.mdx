...
If you would like the vector only rotated, extract the rotational component of the transform and apply it to the vector. This does not hold the same restriction as above.
