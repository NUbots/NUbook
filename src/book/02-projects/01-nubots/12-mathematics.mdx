...
An example of an OBN is the **standard basis**
...
To make computations such as **inner product** or **cross product** with coordinates, the vectors must be relative to the **same basis**.
