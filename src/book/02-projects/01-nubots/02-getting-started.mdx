...
A Linux operating system is recommended for running NUbots code, but any operating system should work. Currently Windows is unsupported but this may change in the future. You can find free downloads for [Ubuntu](https://ubuntu.com/) online. Instructions for getting started with NUbots code can also be found at [the NUbots repository](https://github.com/NUbots/NUbots).

### Git

To begin with, you will need to get the GitHub repository onto your computer. In Linux, to do this open a terminal. The following commands will install git and clone the repository.
...
Run the docker app that was installed which should add a docker icon to the menu bar.
