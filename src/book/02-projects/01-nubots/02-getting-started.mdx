...
Linux is recommended for running NUbots code, but any operating system should work. You can find free downloads for [Ubuntu](https://ubuntu.com/) online.
...
The repository will be cloned to whichever folder you are in the terminal.

### Docker

Now that the repository is on your computer, install Docker.
