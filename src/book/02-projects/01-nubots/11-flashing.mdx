...
1. If you are using a brand new NUC, Boot into the BIOS on the NUC
   ...
   - Navigate to "Power" then set "After Power Failure" to "Power On"
     ![BIOS Power Menu](../../../images/flashing_bios_power.jpg 'BIOS Power Menu')
   - Navigate to "Boot" and then "Boot Configuration"
     ...
     - Ensure "USB" is enabled in "Boot Devices"
       ![BIOS Boot Configuration Menu](../../../images/flashing_bios_boot_configuration.jpg 'BIOS Boot Configuration Menu')
   - Navigate to "Secure Boot" and disable "Secure Boot"
     ![BIOS Secure Boot Menu](../../../images/flashing_bios_secure_boot.jpg 'BIOS Secure Boot Menu')
...
1. Once the system has booted into the LiveUSB environment on the robot, ensure the robot has an active network connection
   ...
   - ![LiveUSB Environment](../../../images/flashing_liveusb.jpg 'LiveUSB Environment')
   - Run `ip addr` and look for a `inet` line that has a valid IP address on it. If you can't see one you don't have a network connection. Alternatively, run `ping -c 3 google.com` and look for a response time.
     ...
     ![Internet connection](../../../images/flashing_internet.jpg 'Internet connection')
     ![No internet connection](../../../images/flashing_no_internet.jpg 'No internet connection')
...
![Login](../../../images/flashing_login.jpg 'Login')
...
![Known network interfaces](../../../images/flashing_known_interfaces.jpg 'Known network interfaces')
