...
Well done! You did it! If you did not, check out the troubleshooting section. If this does not help, ask a teammate for help on Slack!
...
Config files can be found in the config folder.
Real Robot
...
Config files can be found in the config folder, and can be robot specific. 
