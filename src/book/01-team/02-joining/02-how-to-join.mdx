...
1. Submit an application. There will be a link to the application form on our [Facebook page](https://www.facebook.com/NubotsRobotics/) or [LinkedIn page](https://www.linkedin.com/company/nubots).
