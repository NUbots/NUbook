...
- [NUWebots](https://github.com/NUbots/NUWebots) - Controllers, models and worlds for Webots, a robotics simulator.
- [NUcontroller](https://github.com/NUbots/NUcontroller) - Subcontroller firmware.
- [NUware](https://github.com/NUbots/NUware) - CAD models, PCB schematics and other hardware design files.
