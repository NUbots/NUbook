...
- [NUbots](https://github.com/NUbots/NUbots) - C++ codebase that runs on the robots and NUsight, the web-based debugging environment we used to understand and improve our systems.
