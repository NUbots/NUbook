...
We hold weekly meetings on Zoom at **Friday from 1-2pm**. This time may change based on team members' availabilities.
...
- [NUbots](https://github.com/NUbots/NUbots) - C++ codebase that runs on the robots, or locally via simulation and NUsight, the web-based debugging environment we used to understand and improve our systems.
