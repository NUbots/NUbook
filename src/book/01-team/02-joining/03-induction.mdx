...
The CESE Work, Health and Safety Canvas site contains all the information needed to obtain swipe card access to the NUbots lab. Ask the NUbots Team Leader for a link to self-enrol in the site if you are not already enrolled. On the site homepage, click on the 'Newcastle Robotics Laboratory' banner.

## Safety Documentation

The [Electrical Engineering Safety Manual](https://uonstaff.sharepoint.com/:w:/s/SENG-WKSP/ERxPXuzKVflJmZ3MfjyhOmQB_nylPe7m9IjWAsoKLuUlsg?e=kaHftc) is required reading. The second required reading is the [risk assessment](./assets/risk-assessment.pdf) for the lab.

## ES Lab Induction

After reading the safety documentation, you are required to complete the ES Laboratory Induction. This can be accessed by clicking the link in step 2 on Canvas. Once you have finished the quiz, navigate back to the NUbots induction page.

You must score **100%** in the quiz. **This quiz must be completed by all team members each year**, even if you already have swipe card access.
...
The final step on Canvas involves an embedded app that allows you to request access. After signing in to the app with your student details, you will see a form. Select the NUbots access group and choose one of the academics to approve the request. If any steps are not complete, the app will indicate this. Once the steps are all complete, you can submit your request for swipe card access.
...
Alongside the induction, new team members sign a [talent consent form](./assets/talent-consent-form), where students can choose to accept or decline permissions to use their image in social media posts.

The Canvas WHS site additionally contains SOPs for NUbots activities.
