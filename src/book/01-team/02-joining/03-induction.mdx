...
The final step on Canvas involves an embedded app that allows you to request access. After signing in to the app with your student details, you will see a form. Select the NUbots access group and choose Alex Mendes to approve the request. If any steps are not complete, the app will indicate this. Once the steps are all complete, you can submit your request for swipe-card access.

It may take a few days for the application to be approved and the request sent to IFS to enable swipe-card access. Once this is done, you can use your student card to access the external doors of ES and the NUbots lab between the hours of 7am and 10pm, any day of the week.
