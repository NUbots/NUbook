...
- Find a replacement for CM740’s quick so we can buy or make them before the end of the year.
  - Redesign NUsense to only contain the core functionality. Additional functionality can be added with daughterboards/shields, creating a more modular system.
