...
NUpbr generates semi-synthetic data to train vision. Pre-generated datasets for training the Visual Mesh are on the Network-Attached Storage (NAS) in the lab.
