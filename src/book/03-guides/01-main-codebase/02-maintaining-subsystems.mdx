...
Before vision can work on the robot, odometry and kinematics must work on the robot. The position of the mesh and green horizon are reliant on odometry and kinematics - large inaccuracies can cause problems with vision detecting objects. 
