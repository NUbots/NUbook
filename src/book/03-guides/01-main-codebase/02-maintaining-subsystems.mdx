...
3. Run `webots_keyboardwalk` in NUbots. [See the Getting Started page to set up the NUbots codebase](/guides/main/getting-started).
4. Run NUsight (or PlotJuggler) and observe the graphs for the torso to world transform's rotational and translational error.
