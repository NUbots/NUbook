...
L Right Shoulder Pitch  Angle: +1.963 Gain:  30.0
L Left Shoulder Pitch   Angle: +1.963 Gain:  30.0
L Right Shoulder Roll   Angle: -0.124 Gain:  30.0
L Left Shoulder Roll    Angle: +0.124 Gain:  30.0
L Right Elbow           Angle: -2.443 Gain:  30.0
L Left Elbow            Angle: -2.443 Gain:  30.0
...
After you copy the script to your computer, you should commit it to a new branch and make a pull request to merge it into the `master` branch on GitHub; unless the changes are not suitable to keep, in which case you can discard them. For information on Git visit the [Git guide](/guides/general/git).
