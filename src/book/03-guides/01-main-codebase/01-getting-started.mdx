...
1. Install npm and Node.js by running

   ```bash
   sudo apt install npm nodejs
   ```

2. Configure the package repository and install yarn by running
...
7. The terminal will output a link - [localhost:9090](localhost:9090). Visit it to view NUsight.
