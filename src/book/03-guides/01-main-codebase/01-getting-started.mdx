...
2. With the target platform selected, choose the binaries (called "roles") that you want to build. You do this by running the following command:
   ...
   Next, press <kbd>c</kbd> to configure and then <kbd>g</kbd> to generate the build list and exit the menu with <kbd>e</kbd>.
...
With the code built, you can run the code on a real robot or on your computer using a simulated robot.
