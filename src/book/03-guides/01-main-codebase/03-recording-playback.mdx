...
4. Run the binary for the role you want to record.
   ...
   **On a real robot:** SSH into the robot using `ssh nubots@<address>` and run the binary built for the role you want to record. For our example, run `./sensortest`.
