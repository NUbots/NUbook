...
- `@brief` A brief description of the following code. Every documenting comment should have this.
- `@detail` All the details that someone using this thing might need to know beyond what is provided in other directives.
...
HTML can be used, but should be kept to simple tags like `<b>` and `<em>`.
