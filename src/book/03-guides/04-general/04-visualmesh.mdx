...
Now, we're going to make a dummy dataset by repeating these files. We're can to do this using a bash loop, such as the following one, which simply prints the numbers 1 to 10 to the terminal:
