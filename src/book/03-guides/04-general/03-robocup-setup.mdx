...
- If our [team ID changes](https://github.com/RoboCup-HumanoidSoccerLeague/GameController/blob/master/config/teams.yaml), both the team ID in `GlobalConfig.yaml` and the IP addresses in `RobocupConfiguration.yaml` must be updated.
