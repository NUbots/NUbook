...
- When you clone (download) the code, you should do it in the WSL Ubuntu terminal, in your home folder. Outside of WSL, this path will be of the form `\\wsl$\Ubuntu\home\<USERNAME>\NUbots`, where `<USERNAME>` is the username you set up for Ubuntu. This path should be the one you use to open the code in text editors such as Visual Studio Code.
