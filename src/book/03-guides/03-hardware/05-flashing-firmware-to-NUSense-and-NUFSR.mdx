...
Furthermore, running _Debug_ and then exiting the debug session has more of less the same effect as running _Run_.
...
6. Cleaning the project is often useful for troubleshooting cached errors, etc. It clears the build cache. Go to _Project > Clean ..._ or right-click on the NUSense project under the _Project Explorer_ tab and click _Clean Project_.
