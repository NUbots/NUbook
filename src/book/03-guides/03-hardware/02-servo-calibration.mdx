...
The servos come with a default id and baudrate. When a servo is firt used, these parameters must be updated. Servo calibration is performed when a servo has the gearset relplaced. A link to the required software can be found at:
