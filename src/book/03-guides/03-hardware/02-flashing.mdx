...
<!--- ↓↓↓ UPDATE MIRRORS HERE ↓↓↓ -->
1. Download the [Arch Linux LiveUSB image matching the date of the mirrorlist in our Dockerfile](https://archive.archlinux.org/iso/2022.07.01/) and burn it on to a [USB thumb drive](https://wiki.archlinux.org/index.php/USB_flash_installation_media#In_GNU/Linux) using the following instructions
