...
2. Plug the other battery cable into the main output cable of the charger, this may require an adaptor, as seen in the section on using a battery in a robot.
...
## Storing and Travelling with batteries
...
If the cables on the battery are damaged, it is a good idea to wrap the damaged sections separately in electrical tape to prevent them short cicruiting against each
