...
[Install Webots 2022b from the GitHub release](https://github.com/cyberbotics/webots/releases/R2022b).
...
```bash
git clone https://github.com/RoboCup-Humanoid-TC/hlvs_webots
```
...
1. Install dependencies for the referee:
   ...
   ```bash
   cd hlvs_webots/controllers/referee
...
2. Set up the game configuration.
   ...
   1. Open the [game.json file](https://github.com/RoboCup-Humanoid-TC/hlvs_webots/controllers/referee/game.json).
