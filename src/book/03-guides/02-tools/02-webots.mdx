...
3. (Optional) If you want to run `webots/robocup`, you will need GameController.
   Refer to the [GameController Setup](/guides/tools/gamecontroller) guide for installation and setup instructions.
