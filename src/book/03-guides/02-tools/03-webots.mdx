...
1. Find your local IP address by running the following.

   ```sh
   hostname -I
   ```

   Your hostname will usually be the first one in the output returned. For example if `hostname -I` returns `10.1.0.207 10.1.0.139 172.17.0.1`, use `10.1.0.207`.
