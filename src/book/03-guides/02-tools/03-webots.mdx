...
7. Open a NUbots world file inside Webots.
   ...
   2. In the pop-up, navigate to the [NUbots/NUWebots/worlds](https://github.com/NUbots/NUWebots/worlds) folder on your computer and open the world you would like to run.
